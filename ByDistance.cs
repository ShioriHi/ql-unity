...
public class ByDistance : MonoBehaviour
{
    ...
    [Space(5), Tooltip("HMIを起動する閾値")] public float thresholdOfDistance1;
    [Space(5), Tooltip("HMIを起動する閾値")] public float thresholdOfDistance2;
    [Header("値を観測")]
    [Space(5), Tooltip("電動車椅子との距離")] public float Distance;
    [Space(5), Tooltip("歩行者の存在角度")] public float RelativeAngle;
    ...
    void Update()
    {
        ...
        //RelativeAngle1 = Vector3.Angle(pos_rel, dir_w);
